...
public class ProductResourceIT {
	...
	@Test
	public void findlAllShouldReturnSortedPageWhenSortByName() throws Exception {
		ResultActions result = 
				mockMvc.perform(get("/products?page0&size=12&sort=name,asc",nonExistingId)
	...
	public void updateShouldReturnProductDTOWhenIdExists() throws Exception{		
		...
		String expectedDesctription = productDto.getDescription();
